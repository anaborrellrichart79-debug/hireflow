...
('Háblame de ti','personal','basic'),
('¿Cómo te definirías en tres palabras?','personal','intermediate'),
('¿Qué conoces de nuestra empresa?','personal','advanced'),
('¿Podrías explicarme, como si yo no fuera del sector, una herramienta o concepto clave de tu día a día y para qué sirve?','technical','basic'),
...
('Elige dos herramientas o tecnologías parecidas que hayas usado. ¿En qué se diferencian y cuándo usarías cada una?','technical','basic'),
('Algo que funcionaba ayer ha dejado de funcionar hoy y nadie sabe por qué. ¿Cuál es el primer paso que das para diagnosticarlo?','technical','intermediate'),
('¿Cómo mejorarías un proceso que actualmente tarda demasiado tiempo o consume muchos recursos?','technical','intermediate'),
('¿Cómo decides qué herramienta o tecnología usar al empezar un proyecto nuevo? Ponme un ejemplo real.','technical','intermediate'),
('En esta pizarra, dibuja el esquema de un proyecto en el que hayas trabajado y explícame cómo se conectan sus partes.','technical','intermediate'),
('Si tuvieras que diseñar desde cero el sistema o proceso con el que trabajabas en tu último puesto, ¿qué harías distinto y por qué?','technical','advanced'),
...
('¿Cómo crees que la inteligencia artificial afectará a los procesos actuales de nuestro sector?','technical','advanced'),
('Yo defiendo una solución y tú propones otra distinta. Convénceme de por qué tu enfoque es mejor en términos de escalabilidad y costes.','technical','advanced'),
...
('Piensa en uno de los valores de esta empresa. ¿Puedes darme un ejemplo de tu vida personal o profesional en el que lo hayas aplicado sin que nadie te lo pidiera?','culture_fit','advanced'),
